...
export default function Navigation() {
  ...
  return (
    <nav
      className={`fixed top-2 sm:top-4 left-1/2 transform -translate-x-1/2 z-50 transition-all duration-500 max-w-[95vw] sm:max-w-none ${
        isScrolled
          ? 'nav-blur rounded-full px-3 sm:px-4 md:px-6 py-2 sm:py-2.5 md:py-3 shadow-2xl'
          : 'bg-transparent'
      }`}
    >
