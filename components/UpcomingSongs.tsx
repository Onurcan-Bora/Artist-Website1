        ...
        <div className="text-center space-y-8 sm:space-y-12">
          ...
          <div className="glass-effect-strong rounded-2xl sm:rounded-3xl p-6 sm:p-8 md:p-12 border border-white/10 hover:border-white/20 transition-all duration-500 hover:scale-105 gradient-bg">
            <div className="space-y-4 sm:space-y-6">
              <div className="inline-block px-4 sm:px-5 py-1 sm:py-1.5 gradient-button text-white text-xs font-normal rounded-full shadow-lg border border-white/10 tracking-wide">
                YAKINDA
              </div>
              
              <h3 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-light gradient-text elegant-glow px-2">
                Kopan Eller
              </h3>
              
              <p className="text-sm sm:text-base md:text-lg text-white/80 max-w-xl mx-auto font-light leading-relaxed px-2">
                Yeni single'ım "Kopan Eller" çok yakında tüm dijital platformlarda!
              </p>

              <div className="flex justify-center pt-2 sm:pt-4">
                <div className="px-4 sm:px-6 py-2 sm:py-3 glass-effect rounded-xl sm:rounded-2xl border border-white/10 transform hover:scale-105 transition-all">
                  <p className="text-xs text-white/50 font-light">Çıkış Tarihi</p>
                  <p className="text-base sm:text-lg font-light gradient-text-fast mt-1">Çok Yakında</p>
                </div>
              </div>
              ...
              <div className="pt-2 sm:pt-4 space-y-2">
                <button 
                  ...
                  className="px-8 sm:px-10 py-3 sm:py-3.5 gradient-button-accent text-white rounded-full text-sm sm:text-base font-normal hover:scale-105 transition-all shadow-lg border border-white/10 button-glow w-full sm:w-auto"
                >
                  İlk Sen Haberdar Ol
                </button>
                {showMessage && (
